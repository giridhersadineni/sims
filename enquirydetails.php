...
$sql = "select * from enquiries where enquiryid=".$_GET['id'];
...
// Check if file already exists
       if (file_exists($target_dir.$row["firstname"].$row['enquiryid'].".jpg")) {
        unlink($target_dir.$row["firstname"].$row['enquiryid'].".jpg");
        $uploadOk = 1;
       }
// Check file size
...
{
$target_file = $target_dir . $row["firstname"].$row["enquiryid"].".jpg";
if (move_uploaded_file($_FILES["profilepic"]["tmp_name"], $target_file)) {
$nsql="update enquiries SET `imgname`='".$row["firstname"].$row["enquiryid"].".jpg'"." where enquiryid=".$_GET["id"];
...
<div class="row">
<div class="img">
<div class="col-md-3 col-lg-3 " align="center"><img src=<?php echo '"uploads/profilepics/'.$row['imgname'].'"';?>  alt="user pic" class="img-rounded" style="width: 150px;"/> </div>
<br>
...
<!-- Modal body -->
<form action=<?php echo '"enquirydetails.php?id='.$_GET['id'].'"';?> method="POST" enctype="multipart/form-data">
...
<td><center><?php echo $row["doj"]?></center></td>
</tr>
...
<td>Phone Number:</td>
<td><center><?php echo $row["contactdetails"]?></center></td>
</tr>                    
</tbody>
</table>
<br>
